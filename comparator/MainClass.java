...
/**
 * @author Lavin
 *	Example Showing Custom Comparator. 
 */
public class MainClass {
	...
	public static void main(String[] args) {
		...
		/**
		 * Create Object of Comparators
		 */
		AgeSort ageSort = new AgeSort();
		HeightSort heightSort = new HeightSort();
		...
		/**
		 * Pass Array and any Comparator (gradeSort, ageSort, heightSort, scoreSort)
		 */
		Arrays.sort(students, ageSort);
